...
* Proportion of station entrance/exit without vending allow entrance is `r filter(NYC_df, entry == T | exit_only == "Yes") %>% filter(vending == F) %>% distinct(line, station_name) %>% nrow() / nrow(distinct(NYC_df,line, station_name))`.
